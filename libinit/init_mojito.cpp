...
void load_vendor_props() {
    ...
    if (hwname.find("sunny") != std::string::npos) {
        ...
        property_override("ro.build.fingerprint", "Redmi/mojito/mojito:12/RKQ1.210614.002/V14.0.9.0.SKGMIXM:user/release-keys");
        property_override("ro.vendor.build.fingerprint", "Redmi/mojito/mojito:12/RKQ1.210614.002/V14.0.9.0.SKGMIXM:user/release-keys");
        property_override("ro.bootimage.build.fingerprint", "Redmi/mojito/mojito:12/RKQ1.210614.002/V14.0.9.0.SKGMIXM:user/release-keys");
